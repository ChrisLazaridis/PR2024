...
class NeuralNetwork:
    ...
    def __init__(self, input_dim: int, initial_lr: float = 0.2, decay_rate: float = 0.05, batch_size: int = 2048,
                 epochs: int = 125) -> None:
        """
        ...
        self.optimizer: torch.optim.SGD = torch.optim.SGD(self.model.parameters(), lr=initial_lr, momentum=0.9000000000000004)
